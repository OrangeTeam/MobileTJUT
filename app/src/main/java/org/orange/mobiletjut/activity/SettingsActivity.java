...
public class SettingsActivity extends Activity {
     ...
     */
    private static void bindPreferenceSummaryToValue(Preference preference, Object currentValue) {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            if (preference instanceof ListPreference) {
                ...
                preference.setSummary(preference.getContext()
                        .getString(R.string.pref_week_number_summary, weekNumber)
                );
            } else {
    ...
    public static class SettingsFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Map<String, ?> currentValues = PreferenceManager
